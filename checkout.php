   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <a href='UserSelect.php' class='btn'>continue shopping</a>
         </div>
      </div>
      ";
   }
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="e.g. taman murni..." name="street" required>
         </div>
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g manjung" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. perak" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
